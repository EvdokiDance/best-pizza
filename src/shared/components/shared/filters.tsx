...
export const Filters: React.FC<Props> = ({ className }) => {
  ...
  return (
    <div className='flex flex-col gap-6'>
        ...
        <CheckboxFiltersGroup title='Размеры' name='sizes' selectedIds={filter.sizes} onClickCheckbox={filter.onAddSizeId} items={[{label: '20 см', value: '20'}, {label: '30 см', value: '30'}, {label: '40 см', value: '40'}]}/>
